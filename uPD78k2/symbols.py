...
uPD78213_SYMBOLS.update(
{
    ...
    0x16f1: ("read_ext_22a", "Read 3B in L, DE"),
    0x16fe: ("read_ext_22d", "Read 3B in L, DE"),
    ...
    0x179e: ("read_disp_cfg(A)", "Read display config[A] into IRAM"),
    0x17ba: ("read_disp_def", "Read default display config into IRAM"),
    ...
    0x182f: ("disp_hw_cfg()", "Write display cfg to HW ?"),
    0x1aac: ("disp_buf(A, B, C)", "Write char A at position B,C"),
    ...
    0x1cf2: ("disp_get_buf_add(B,C)", "DE=buffer address for row/col, A=bit offset"),
    0x1d2f: ("disp_get_pos()", "Read row, column from IRAM"),
    ...
    0x1e37: ("P0_write_cP3.6(A)", "Write A to P0 using P3.6, clr P3.5"),
    0x1e49: ("P0_write_cP3.7(A)", "Write A to P0 using P3.7, clr P3.5"),
    0x1e49: ("P0_write_cP3.67(A)", "Write A to P0 using P3.6 and P3.7, clr P3.5"),
    0x1e6f: ("P0_write_sP3.6(A)", "Write A to P0 using P3.6, set P3.5"),
    0x1e89: ("P0_write_sP3.7(A)", "Write A to P0 using P3.7, set P3.5"),
    0x1ea1: ("read_ext_byte(L, DE)", "Read byte at DE from page L"),
    0x1eb0: ("read_ext_word(L, DE)", "Read word at DE from page L"),
    0x1ee8: ("Set_P_low(L)", "Set P.3-0 to L"),
